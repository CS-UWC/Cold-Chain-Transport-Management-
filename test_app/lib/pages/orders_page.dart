...
import 'package:test_app/model/order_model.dart';
...
class _OrdersPageState extends State<OrdersPage> {
  ...
  Future<List<Order>> fetchOrders(String token) async {
    ...
    const apiUrl =
        'http://localhost:3001/orders/'; // Replace with your API endpoint
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('My Orders using token: ${widget.token}'),
      ),
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    child: ExpansionTile(
                      ...
                      subtitle: Text(orderList[index].productName ?? 'No Product'),
                      trailing: Text(orderList[index].status ?? 'No Status', style: const TextStyle(color: Colors.green),),
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('Driver ID: ${orderList[index].driverId ?? 'N/A'}'),
                                Text('Temperature: ${orderList[index].tempRange ?? 'N/A'}'),
